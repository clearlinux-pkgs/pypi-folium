...
Version  : 0.19.7
Release  : 19
URL      : https://files.pythonhosted.org/packages/1c/0b/5dea422dfe6abf743f8fb91e0c65ccaaf960b91248fce12dc768855dede6/folium-0.19.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/1c/0b/5dea422dfe6abf743f8fb91e0c65ccaaf960b91248fce12dc768855dede6/folium-0.19.7.tar.gz
...
%prep
%setup -q -n folium-0.19.7
cd %{_builddir}/folium-0.19.7
pushd ..
cp -a folium-0.19.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748959312
...
cp %{_builddir}/folium-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-folium/be0a3c81eed29a80288a85dad3c1b3029496aa92 || :
...
/usr/share/package-licenses/pypi-folium/be0a3c81eed29a80288a85dad3c1b3029496aa92
