...
Version  : 0.15.0
Release  : 5
URL      : https://files.pythonhosted.org/packages/99/0d/e6a83f38fe709b5130b6a4cf416a9a08b9fcc2d55b5df8a11ed29eb67fd3/folium-0.15.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/99/0d/e6a83f38fe709b5130b6a4cf416a9a08b9fcc2d55b5df8a11ed29eb67fd3/folium-0.15.0.tar.gz
...
%prep
%setup -q -n folium-0.15.0
cd %{_builddir}/folium-0.15.0
pushd ..
cp -a folium-0.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699374785
