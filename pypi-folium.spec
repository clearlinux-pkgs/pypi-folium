...
Source0  : https://files.pythonhosted.org/packages/ca/09/469cbe217cddc0cb11542fa38f50014e548b2dda010f67185b0579885cd6/folium-0.19.4.tar.gz
...
%prep
%setup -q -n folium-0.19.4
cd %{_builddir}/folium-0.19.4
pushd ..
cp -a folium-0.19.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736176524
