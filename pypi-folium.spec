...
Source0  : https://files.pythonhosted.org/packages/d8/75/4ffc50fac2a881f07c48232d6200d50ca040a83e2e0e96f523610eec27a7/folium-0.18.0.tar.gz
...
%prep
%setup -q -n folium-0.18.0
cd %{_builddir}/folium-0.18.0
pushd ..
cp -a folium-0.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729606966
