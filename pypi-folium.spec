...
Source0  : https://files.pythonhosted.org/packages/0b/4e/f5ef1fcacaa669465cc2ee0c71718f2093e89ec4086125fc5f3d335ed62f/folium-0.19.5.tar.gz
...
%prep
%setup -q -n folium-0.19.5
cd %{_builddir}/folium-0.19.5
pushd ..
cp -a folium-0.19.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740694610
